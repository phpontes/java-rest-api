...
class ContactsApplicationTests {
	...
	private Contact[] contacts = new Contact[] {
			new Contact("1", "João Canabrava", "6135342524"),
			new Contact("2", "Adamastor Pitaco", "4145433332"),
			new Contact("3", "José das Couves", "3452125631"),
	};
	...
	public void getAllContactsTest() throws Exception {
		...
		mockMvc.perform(request)
				...
				.andExpect(jsonPath(
						"$.[?(@.id == \"2\" && @.name == \"Adamastor Pitaco\" && @.phoneNumber == \"4145433332\")]")
						.exists());
	}
	...
	public void validContactCreation() throws Exception {
		RequestBuilder request = MockMvcRequestBuilders.post("/contact")
				...
				.content(objectMapper.writeValueAsString(new Contact("Chico Butico", "123456789")));
